...
const topicLoaders: Record<string, () => Promise<Topic>> = {
  ...
  'unsung-heroes-spies': () => import('./topics/unsung-heroes-spies').then(m => m.unsungHeroesSpies),
  'unsung-heroes-workers-rights': () => import('./topics/unsung-heroes-workers-rights').then(m => m.unsungHeroesWorkersRights),
  'unsung-heroes-womens-rights': () => import('./topics/unsung-heroes-womens-rights').then(m => m.unsungHeroesWomensRights),
  'unsung-heroes-civil-rights': () => import('./topics/unsung-heroes-civil-rights').then(m => m.unsungHeroesCivilRights),
  'unsung-heroes-rebels': () => import('./topics/unsung-heroes-rebels').then(m => m.unsungHeroesRebels),
  'how-stuff-smells': () => import('./topics/how-stuff-smells').then(m => m.howStuffSmells),
  'women-in-science': () => import('./topics/women-in-science').then(m => m.womenInScience),
...
export const lessons: Record<string, Lesson> = {
  ...
  'unsung-heroes': {
    ...
    title: 'Unsung Heroes',
    icon: '\u{1F9B8}',
    description: 'Meet the secret agents, rebels, and everyday heroes who changed the world by standing up for what\'s right!',
    status: 'active',
    topicIds: [
      'unsung-heroes-spies',
      'unsung-heroes-workers-rights',
  ...
  science: {
    ...
    title: 'Science',
    icon: '\u{1F52C}',
    description: 'Explore the science of smell, amazing women scientists, ecosystems, extreme weather, and climate change!',
    status: 'active',
    topicIds: [
      'how-stuff-smells',
      'women-in-science',
